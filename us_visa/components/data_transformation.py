    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ("OneHotEncoder", oh_transformer, oh_columns),   #Converts categorical variables into a format that can be provided to machine learning algorithms
                    ("Ordinal_Encoder", ordinal_encoder, or_columns),  #Converts categorical variables with an inherent order
